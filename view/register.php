                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" class="container-fluid">
                                    ...
                                    <div class="row justify-content-around">
                                        <!--Facebook-->
                                        <button class="col-1 border-secondary bg-primary fb-login-button" data-width="400" data-size="" data-button-type="" data-layout="" data-auto-logout-link="false" data-use-continue-as="false" onclick="checkLoginState()">
                                            <img class="img-fluid" src="/img/stockImages/login_register/facebookLogo.png" alt="">
                                        </button>
                                        <!--X-->
                                        <button class="col-1 border-secondary bg-primary"><img class="img-fluid" src="/img/stockImages/login_register/xLogo.png" alt=""></button>

                                        <!--Google-->
                                        <button class="col-1 border-secondary bg-primary" type="submit" name="gIdentify"><img class="img-fluid" src="/img/stockImages/login_register/googleLogo.png" alt=""></button>
                                </form>
                                <!-- Registration form -->
