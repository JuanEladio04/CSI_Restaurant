...
<body>
  <div id="background-<?php echo $CURRENT_PAGE; ?>" class="container-fluid p-0 m-0">
    <div class="row m-0 p-0">
      ...
      <div class="container-fluid presentacion col-12 text-center my-5 justify-content-around">
        ...
        <div class="container-fluid col-3 d-lg-none d-sm-block">
          <div class="row tittle lobster">
            <a href="#" class="btn btn-successful roundedButton my-4">Carta</a>
            <a href="#" class="btn btn-successful roundedButton my-4">Ofertas</a>
            <a href="#" class="btn btn-successful roundedButton my-4">Reservas</a>
          </div>
        </div>
      </div>

      <!--Menu carousel-->
      <div class="bg-dark p-5 my-5 container-fluid d-block">
      ...
      <!--Comentaries-->
      <div class="bg-primary row container-fluid p-5 my-5">
